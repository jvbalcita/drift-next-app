...
export function NetworkProfilesPage({ snapshot, dispatch, view = "profiles", onViewChange }: { snapshot: ControlPlaneSnapshot; dispatch: DispatchIntent; view?: string; onViewChange?: (view: string) => void }) {
  ...
  return <>
    ...
    <OperatorNotice>Address policies use documentation ranges. Saving or scanning does not open a network socket or register an endpoint. Device Provisioning and Registration stay separate from Discovery scans.</OperatorNotice>

...
export function RunsPage({ snapshot, dispatch, view = "active", onViewChange }: { snapshot: ControlPlaneSnapshot; dispatch: DispatchIntent; view?: string; onViewChange?: (view: string) => void }) {
  ...
  return <>
    ...
    <Tabs value={view} onValueChange={onViewChange} className="mt-6"><TabsList aria-label="Run views"><TabsTrigger value="active">Active</TabsTrigger><TabsTrigger value="history">History</TabsTrigger><TabsTrigger value="failed">Failed / Indeterminate</TabsTrigger></TabsList>

export const navigation = [
  ...
  { section: "Network Profiles", hash: "network-profiles", views: [{ id: "profiles", label: "Profiles" }, { id: "scans", label: "Discovery Scans" }, { id: "candidates", label: "Pending Candidates" }, { id: "endpoints", label: "Registered Endpoints" }, { id: "provisioning", label: "Device Provisioning" }, { id: "history", label: "History" }] },

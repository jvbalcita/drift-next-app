...
| P15 — artifacts/media transport | in progress | Next phase after P14 merge. Depends on P9/P10/P10.5 artifact contracts plus explicit media/transport design; no implementation started on this tip. |
...
- **P15 execution gate:** phase is now **in progress**. Artifact/media transport work may begin from the P9/P10/P10.5 foundation; no fleet or remote media infrastructure is authorized by this note.

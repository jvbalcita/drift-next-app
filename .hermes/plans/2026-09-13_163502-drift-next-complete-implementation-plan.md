...
- **P6:** `artisan/phase-6-mock-registry-discovery` is active. Do not infer P6 implementation from the branch/plan status; no P6 implementation is included in this completed P5 handoff.
- **P6 implementation:** mock registry/discovery behavior is implemented at commit `68a48bb`; the phase remains subject to PR/CI/review/merge verification before P7 starts.
...
- **P10:** durable workflow/run/replay behavior is implemented at `d476294`; local Go, race, frontend, Buf, generated-artifact, secret-scan, and diff gates passed. PR/CI/merge reconciliation remains part of this phase handoff.

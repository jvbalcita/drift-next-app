...
| P8 — fake edge/device actors | in progress | Next separately reviewed slice: fake edge boundary, per-device actors, scripted observations, and multi-target failure isolation with no Android or ADB integration. |

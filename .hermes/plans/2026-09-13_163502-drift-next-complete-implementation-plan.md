...
| P9 — observations/inventory/health/events/artifacts | in progress | Next separately reviewed slice: immutable sanitized observations, exact-first target indexes, operational projections, health/event history, and artifact metadata. |

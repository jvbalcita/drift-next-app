...
| P13 — one-device adapter spike | blocked | Requires completion of the preceding safety/fake-runtime and recorder/skill gates, plus Boss explicitly authorizes a lab-only device test and Sentinel/security review of the adapter boundary; no device operations are authorized. |
...
- **P13 authorization gate:** stop before creating a P13 branch. Proceed only after Boss explicitly authorizes a lab-only device test and Sentinel/security review of the adapter boundary.

...
| P12 — accounts/settings/policy UX | in progress | `artisan/phase-12-accounts-settings-policy-ux` is the active implementation branch; bounded account, settings, policy, assignment-reference, connector-boundary, history, decision, and redaction work remains. |

...
| P7 — lease/fencing/policy safety kernel | in progress | Next separately reviewed slice: durable control sessions, per-device leases/fencing, typed action catalog, policy decisions, cancellation, emergency stop, and indeterminate completion. |

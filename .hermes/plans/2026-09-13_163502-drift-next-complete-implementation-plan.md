...
| P10 — workflows/runs/replay evidence | in progress | Next separately reviewed slice: versioned workflows, target-set snapshots, per-target runs, replay evidence, bounded fake assistance, and indeterminate reconciliation. |

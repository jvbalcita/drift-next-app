...
const (
	...
	WorkspaceServiceName = "drift.v1.WorkspaceService"
)
...
const (
	...
	// ListWorkspaces RPC.
	WorkspaceServiceListWorkspacesProcedure = "/drift.v1.WorkspaceService/ListWorkspaces"
	// WorkspaceServiceGetWorkspaceProcedure is the fully-qualified name of the WorkspaceService's
	// GetWorkspace RPC.
	WorkspaceServiceGetWorkspaceProcedure = "/drift.v1.WorkspaceService/GetWorkspace"
)

// WorkspaceServiceClient is a client for the drift.v1.WorkspaceService service.
...
// NewWorkspaceServiceClient constructs a client for the drift.v1.WorkspaceService service. By
...
func NewWorkspaceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WorkspaceServiceClient {
	...
	workspaceServiceMethods := v1.File_drift_v1_organization_proto.Services().ByName("WorkspaceService").Methods()
...
// ListWorkspaces calls drift.v1.WorkspaceService.ListWorkspaces.
...
// GetWorkspace calls drift.v1.WorkspaceService.GetWorkspace.
...
// WorkspaceServiceHandler is an implementation of the drift.v1.WorkspaceService service.
...
func NewWorkspaceServiceHandler(svc WorkspaceServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/drift.v1.WorkspaceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWorkspaceServiceHandler) ListWorkspaces(context.Context, *connect.Request[v1.ListWorkspacesRequest]) (*connect.Response[v1.ListWorkspacesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("drift.v1.WorkspaceService.ListWorkspaces is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) GetWorkspace(context.Context, *connect.Request[v1.GetWorkspaceRequest]) (*connect.Response[v1.GetWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("drift.v1.WorkspaceService.GetWorkspace is not implemented"))
}

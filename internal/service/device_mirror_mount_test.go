...
func (m mountMirrors) Open(context.Context, string, string) (transportconnect.DeviceMirrorStream, error) {
	return m.stream, nil
}
...
func (m *mountMirrorPointer) Open(context.Context, string, string) (transportconnect.DeviceMirrorStream, error) {
